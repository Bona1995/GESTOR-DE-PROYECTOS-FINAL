...
from datos.datos import (crearTablaYDatosIniciales, agregarProductosDB, verProductoNombreDB, verProductoCategoriaDB, verProductoRangoPreciosDB, verProductoCantidadDB, verProductosDB, eliminarRegistroDB, modificarCantidadProductosDB, modificarPrecioProductosDB)
...
def agregarProducto(productoAgregar):
    ...
    centinela= agregarProductosDB(productoAgregar) 
    return centinela
...
def modificacionCantidad(modificCantidad, segunPosicion):
    """Actua como puente intermedio entre presentacion y datos"""
    centinela= modificarCantidadProductosDB(modificCantidad, segunPosicion)
    return centinela

def modificacionPrecio(nuevoPrecio, segunPosicion):
    """Actua como puente intermedio entre presentacion y datos"""
    centinela= modificarPrecioProductosDB(nuevoPrecio, segunPosicion)
    return centinela

def eliminacionRegistro(segunPosicion):
    """Actua como puente intermedio entre presentacion y datos"""
    centinela= eliminarRegistroDB(segunPosicion)
    return centinela
